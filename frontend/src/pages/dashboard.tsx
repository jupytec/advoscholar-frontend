    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                <CardWrapper title='Total Number of Students' value={78345} type='student' />
                <CardWrapper title='Total Number of Employees' value={4500} type='employee' />
                <CardWrapper title='Total Number of Inventories' value={3500} type='inventory' />
            </div>
            <div className='flex flex-col lg:flex-row w-full mt-5 h-auto lg:h-[612px] gap-6'>
                ...
                <div className="w-full lg:w-2/4 flex flex-col gap-4 ">
                    ...
                    <div className="border h-[306px] p-4 border-solid border-white-100 rounded-md shadow-md flex flex-col justify-around">
                        ...
                        <p><span className="text-green-400">+15%</span> vs last term</p>
                        </div>
